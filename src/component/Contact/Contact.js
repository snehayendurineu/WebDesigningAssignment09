        ...
        <Container className="d-flex justify-content-center align-items-center vh-100">
            <div>
                ...
                <Card className="p-3 mt-4" style={{ width: '500px' }}>
                    ...
                    <p><strong>Email:</strong> <a href='mailto:info@jobsearch.com' target='_blank'>info@jobsearch.com</a></p>
                    <p><strong>Phone:</strong> <a href='tel:+1234567890' target='_blank'>+1234567890</a></p>
                </Card>
            </div>
        </Container>
    );
